   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            ...
            <a href="index.php?page=foto&aksi=tambah" class="btn btn-primary waves-effect waves-light" data-toogle="tooltip" data-placement="bottom" title="Tamba Data"><i class="bx bx-plus font-size-16 align-middle mr-2"></i> Picture</a><br><br>
