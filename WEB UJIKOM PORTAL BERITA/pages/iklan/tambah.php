...
<div class="page-title-right">
   <ol class="breadcrumb m-0">
      ...
      <li class="breadcrumb-item active">Create Iklan</li>
   </ol>
</div>
</br>
<div class="col-lg-12">
   <div class="card">
      <div class="card-body">
         <h4 class="card-title mb-4">CREATE IKLAN</h4>
         <form method="post" name="Input" action="../pages/iklan/proses_tambah.php" enctype="multipart/form-data">
            <div class="form-group row mb-4">
               <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Nama Iklan</label>
               <div class="col-sm-9">
                  <input type="text" class="form-control" id="horizontal-firstname-input" name="nama_iklan">
               </div>
            </div>
            <div class="form-group row mb-4">
               <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">URL Website/Sosmed</label>
               <div class="col-sm-9">
                  <input type="text" class="form-control" id="horizontal-firstname-input" name="link_sosmed">
               </div>
            </div>
            <div class="form-group row mb-4">
