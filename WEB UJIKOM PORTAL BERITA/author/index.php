               ...
               <div class="d-flex">
                 ...
                 <div class="dropdown d-inline-block">
                     <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <img class="rounded-circle header-profile-user" src="../pages/images1/profile/<?php echo $_SESSION['gambar'] ?>"
                        alt="Header Avatar">
                     ...
                     <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
                        <a class="dropdown-item" href="?page=profil1"><i class="bx bx-user font-size-16 align-middle mr-1"></i> <span key="t-profile">Profile</span></a>
            ...
            <div data-simplebar class="h-100">
               ...
               <div id="sidebar-menu">
                  ...
                  <ul class="metismenu list-unstyled" id="side-menu">
                     ...
                     <?php @$page = $_GET['page']; ?>
                     <li <?php if ($page == "post1") { ?> class = "active" <?php }  ?>>
                        <a href="?page=post1" class="waves-effect">
                     ...
                     <li <?php if ($page == "foto1") { ?> class = "active" <?php }  ?>>
                        <a href="?page=foto1" class="waves-effect">
                        <i class="bx bx-image-add"></i>
                        <span key="t-calendar">Picture</span>
                        </a>
                     </li>
                     <li <?php if ($page == "video1") { ?> class = "active" <?php }  ?>>
                        <a href="?page=video1" class="waves-effect">
